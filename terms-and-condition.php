...
<head>
    ...
    <title>LAMAA | Terms & conditions</title>
    <!-- Favicon Icon -->
...
<body>
    <div class="container">
        <div class="pg-heading">
            ...
            <img style="height: 80px;" src="images\lamaa-logo.png"
                alt="">
        </div>
        <div class="terms-section">
            <ol type="1">
                ...
                <li>
                    ...
                    <b>cawf.in/lamaa</b>('Website'), including the related mobile site and mobile application 
                    (hereinafter referred to as 'Platform').
                </li> 
                <li>
                    The Platform is owned by <b>LAMAA,</b> a company incorporated under the 
                    Companies Act, 1956 with its registered office at <b>C13 Shivalik Colony, Basant Kaur Marg, Malviya Nagar, India, Delhi</b> (hereinafter referred to as 
                ...
                <li>
                   ...
                   <ol type="1">
                    ...
                    <li>
                        ...
                        jurisdiction of the courts in <b>Haryana,Delhi and Uttar Pradesh.</b> 
                    </li>
                    <li>
