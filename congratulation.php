<?php
session_start();
if (empty($_SESSION['payment_update_msg']))
{
...
$msg = $_SESSION['payment_update_msg'];
unset($_SESSION['payment_update_msg']);
?>
...
<head>
    ...
    <!-- Page Title -->
    <title>CAWF | Congratulations</title>
    <!-- Favicon Icon -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center p-4">
                    <div class="card"
                        ...
                        <?php else: ?>
                            <h4>Your payment proof has been uploaded successfully.</h4>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
